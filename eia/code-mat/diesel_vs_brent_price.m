...
lylbl=ylabel('Diesel Price [2022 USD]');
...
tt=title(sprintf('U.S. Crude and Diesel Prices'),'fontsize',20);

lgn=legend('Diesel Price','Brent Price','fontsize',17);
...
%%
print('~/projects/eia/post/diesel_vs_crude_price_usa','-dpng')
