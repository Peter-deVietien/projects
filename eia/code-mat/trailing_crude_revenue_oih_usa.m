...
lylbl=ylabel('Summed Revenue [Millions 2022 USD]');
...
d.close=moving_average(d.dates_close,d.close,20);

p=plot(d.dates_close,d.close,'linewidth',3);
p.Color(4)=0.5;

tt=title(sprintf('U.S. Domestic Crude Revenue\nTrailing %d Months',trailing_months),'fontsize',30);
...
%%
print('~/projects/eia/post/trailing_crude_revenue_oih_usa','-dpng')
