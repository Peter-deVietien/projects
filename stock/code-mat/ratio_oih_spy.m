...
grid on
lgn=legend(sprintf('Ratio: $OIH/$SPY',ticker1,ticker2),'Today''s Ratio');
...
ttext=sprintf('Ratio of U.S. Oil Field Services ETF\n $OIH divided by S&P 500 $SPY');

text(0.7,0.73,ttext,'fontsize',30,'units','normalized','horizontalalignment','center')
