...
%ylim([0.6 4])
grid on
lgn=legend(sprintf('Ratio: $XES to WTI'),'One New MA','Four Year MA','Today''s Ratio')
lgn.Position=[0.4614 0.4707 0.2039 0.1286];
lgn.Interpreter='none';
...
%%
txt1_str=sprintf('Ratio of $XES to WTI\nBolded: One and Four Year Moving Average',ticker1,ticker2);
txt1=text(datetime(2013,1,1),1.5,txt1_str);
txt1.FontSize=30;
