...
%%
increase_tests=increase_tests/1000;
...
%%
ma_days=7;
bar(dates,moving_average(dates,increase_tests,ma_days))
hold on
...
lgn=legend('Daily Tests','Positive Tests','Hospitalized','ICU','Deaths');
lgn.Position=[0.3398 0.5508 0.1467 0.2256];

print('bar_alltests_hosp_icu','-dpng')