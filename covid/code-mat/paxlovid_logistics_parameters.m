...
ddates=[dt(2021,11,1),dt(2021,12,22),dt(2022,1,16),dt(2022,1,30),dt(2022,2,13), dt(2022,2,27), dt(2022,3,13), dt(2022,3,20), dt(2022,3,27), dt(2022,4,3), dt(2022,4,10)];
ddeliv=[     0,           65,             100,          100,        100,           149,            175,         175,            175,            175,         175]*1000;
