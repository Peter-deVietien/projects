...
countries={'UnitedStates','France','RussianFederation','China','Ethiopia'};
legendstr={'United States','France','Russia','China','Ethiopia'};
nc=numel(countries);
...
lgn.Position=[0.1417 0.6396 0.2367 0.2626];
