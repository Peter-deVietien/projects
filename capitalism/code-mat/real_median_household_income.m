...
t=readtable('~/projects/capitalism/data/real_median_household_income_2020.xls');

dates=t.MEHOINUSA672N +calmonths(6);
income=t.RealMedianHouseholdIncomeInTheUnitedStates_2020CPI_U_RSAdjusted;

%%
bar(dates,income)

ylabel('Real Household Income [2020 USD]')
%%
fig=gcf;
...
text(datetime(2003,1,1),73500,'Bush','fontsize',35,'fontname','Times')
text(datetime(2011,1,1),73500,'Obama','fontsize',35,'fontname','Times')
text(datetime(2018,1,1),73500,'Trump','fontsize',35,'fontname','Times')
...
%%
filename='real_median_household_income';
